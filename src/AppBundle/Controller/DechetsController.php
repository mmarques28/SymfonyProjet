...
/**
 * Description of DechetsController
 *
 * @author mmarques
 */
class DechetsController extends BaseAdminController{
    
    /**
     * @Route("/exportDechetsCSV")
    */
    public function exportAction()
    {

        $em = $this->getDoctrine()->getManager();
        $results=$em->createQuery('SELECT s FROM AppBundle:Dechets s')
                    ->getResult();
        ...
        $response->setCallback(
            function () use ($results) {
                ...
                fputcsv($handle, array('Id','Code','Categorie'), chr(9));
